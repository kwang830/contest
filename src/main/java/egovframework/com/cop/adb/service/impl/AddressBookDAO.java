...
public class AddressBookDAO extends EgovComAbstractDAO{
     ...
     * @throws Exception
     */
    public List<AddressBookUserVO> selectPwdList(AddressBookUserVO adbkUserVO) throws Exception {
        return (List<AddressBookUserVO>) list("AdressBookDAO.selectPwdList", adbkUserVO);
    }
    ...
    /**
     * 사용자 목록에 대한 전체 건수를 조회한다. pwd 리스트 건수
     * 
     * @param AddressBookUser
     * @throws Exception
     */
    public int selectPwdListCnt(AddressBookUserVO adbkUserVO) throws Exception {
        return (Integer)selectOne("AdressBookDAO.selectPwdListCnt", adbkUserVO);
    }
