...
public class DeptSchdulManageDao extends EgovComAbstractDAO {
	...
	public int selectDeptSchdulManageEmpLyrPopupCnt(ComDefaultVO searchVO) {
		return (Integer)selectOne("DeptSchdulManage.selectDeptSchdulManageEmpLyrPopupCnt", searchVO);
	}
}
