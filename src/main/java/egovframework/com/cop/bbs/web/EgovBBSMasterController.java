...
public class EgovBBSMasterController {
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/insertBBSMasterView3.do")
    public String insertBBSMasterView3(@ModelAttribute("searchVO") BoardMasterVO boardMasterVO, ModelMap model) throws Exception {
		BoardMasterVO boardMaster = new BoardMasterVO();
