...
public class Globals {
    ...
    //메인 페이지 - 기업회원
    public static final String MAIN_PAGE2 = EgovProperties.getProperty("Globals.MainPage2");    
    //메인 페이지 - 업무 사용자
    public static final String MAIN_PAGE3 = EgovProperties.getProperty("Globals.MainPage3");    
    //ShellFile 경로
