...
function fn_egov_inquire_qnadetail(qaId) {
	$.ajax({
		type:"POST",
		url:"${pageContext.request.contextPath}/uss/olh/qna/selectQnaDetail.do",
		data: {
			"qaId": qaId,
		},
		dataType:'html',		
...
function fnAddQna(){	
	...
	$.ajax({
		type:"POST",
		url:"${pageContext.request.contextPath}/uss/olh/qna/insertQnaView.do",
		data: {
			"test": "test"			
		},
		dataType:'html',		
...
<form name="qnaForm" id="qnaForm" action="<c:url value='/uss/olh/qna/selectQnaList.do'/>" method="post" onSubmit="fn_egov_search_qna(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<input type="button" class="s_btn" onClick="fnAddQna(); return false;" value="<spring:message code="button.create" />" title="<spring:message code="button.create" /> <spring:message code="input.button" />" />
			</li>
		</ul>
	</div>
