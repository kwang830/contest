...
function fnReply(){
	...
	$.ajax({
		type:"POST",
		url:"${pageContext.request.contextPath}/uss/olh/qna/updateQnaAnswerView.do",
		data: string, 
		dataType:'html',
		timeout:(1000*30),
...
<form name="qnaForm" id="qnaForm"  action="<c:url value='/uss/olh/qna/updateQnaAnswerView.do'/>" method="post">
<div class="wTableFrm">
	<!-- 타이틀 -->
	<h1><img src="/images/bl/bl_circle.gif" class="img_margin1"> ${pageTitle} <spring:message code="title.detail" /></h1>
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<input type="button" class="s_submit" onClick="fnReply(); return false;"  value="<spring:message code="button.reply" />" title="<spring:message code="title.reply" /> <spring:message code="input.button" />" />
