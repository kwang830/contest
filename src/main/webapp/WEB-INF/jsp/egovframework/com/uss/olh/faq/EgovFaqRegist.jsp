...
function fn_egov_regist_faq(){
	...
	if (!validateFaqVO(document.faqVO)) {	
		...
		if(confirm("<spring:message code="common.regist.msg" />")){	
			//form.submit();
	        $("#faqVO").ajaxForm({
	        	url:"${pageContext.request.contextPath}/uss/olh/faq/insertFaq.do",
...
<form:form commandName="faqVO" name="faqVO" action="${pageContext.request.contextPath}/uss/olh/faq/insertFaq.do" method="post" onSubmit="return false;" enctype="multipart/form-data"> 
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<input type="button" class="s_submit" onClick="fn_egov_regist_faq(); return false;" value="<spring:message code="button.create" />" title="<spring:message code="button.create" /> <spring:message code="input.button" />" />
