...
function fnDeleteUser() {
    ...
    if(checkedIds.length > 0) {
        if(confirm("<spring:message code="common.delete.msg" />")){
    		...
    		$.ajax({
    			type:"POST",
    			url:"<c:url value='/uss/umt/EgovUserDelete.do' />",
    			data:{
...
function fnSelectUser(id) {
	...
	$.ajax({
		type:"POST",
		url:"${pageContext.request.contextPath}/uss/umt/EgovUserSelectUpdtView.do",
		data: {
			"selectedId": userId			
		},
		dataType:'html',
...
function fnAddUserView() {
	...
	$.ajax({
		type:"POST",
		url:"${pageContext.request.contextPath}/uss/umt/EgovUserInsertView.do",
		data: string, 
		dataType:'html',
		timeout:(1000*30),
...
<div class="board">
	...
	<tr>
	    ...
	    <td>
	        <input name="checkField" id="checkField" title="checkField <c:out value="${status.count}"/>" type="checkbox"/>
