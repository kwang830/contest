...
<%
	...
	String sModalName = request.getParameter("modalName") == null ? "" : (String)request.getParameter("modalName");
	String sClassName = request.getParameter("className") == null ? "modal" : (String)request.getParameter("className");
%>
