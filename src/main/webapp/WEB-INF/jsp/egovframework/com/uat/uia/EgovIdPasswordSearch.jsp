	...
	<form name="idForm" action ="<c:url value='/uat/uia/searchId.do'/>" method="post">
		...
		<div class="login_type">
			<ul>
				...
				<li style="display: none;"><a id="idEnt" onClick="fnCheckUsrId('ENT');"><spring:message code="comUatUia.idPw.ent" /></a></li>
	...
	<fieldset class="pw_search">
		...
		<div class="login_type">
			<ul>
				...
				<li style="display: none;"><a id="pwEnt" onClick="fnCheckUsrPassword('ENT');"><spring:message code="comUatUia.idPw.ent" /></a></li>
