...
<div id="wrap">     	
		<div id="login_leftcontent">
			<img src="<c:url value='/images/login/009.png'/>" id="visual_login1" style="width:580px;" alt="logo">
			<img src="<c:url value='/images/login/003.png'/>" id="visual_login2" style="width:580px;display:none;" alt="logo">
		</div>
...
<span style="color:gray;">&nbsp;&nbsp;*로그인 후 비밀번호 변경 가능함</span><br></p>
	...
	<img src="<c:url value='/images/header/logo.png'/>" style="margin:10px 0 0px 60px;width:160px;" alt="login title image"  title="login title image">
