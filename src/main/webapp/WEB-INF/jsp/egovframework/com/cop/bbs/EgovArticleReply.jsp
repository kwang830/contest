...
function fn_egov_reply_article(form){
	...
	if (!validateArticleVO(form)) {	
		...
		if(!validateForm){
			//alert('null validateForm'); 2번 호출방지
			return false;
		}
		...
		if(confirm("<spring:message code="common.regist.msg" />")){	
			//form.submit();			
	        $("#articleVO").ajaxForm({
	        	url:"${pageContext.request.contextPath}/cop/bbs/replyArticle.do",
...
<form:form commandName="articleVO" name="articleVO" action="${pageContext.request.contextPath}/cop/bbs/replyArticle.do" method="post" onSubmit="return false;" enctype="multipart/form-data"> 
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<input type="button" class="s_submit" onClick="fn_egov_reply_article(document.articleVO); return false;" value="<spring:message code="button.create" />" title="<spring:message code="button.create" /> <spring:message code="input.button" />" />
