...
<footer id="footer" class="dark">
	...
	<div id="copyrights">
		...
		<div class="container clearfix">
			...
			<div class="col_half">
				Copyright &copy; 2025 IBK System Co. Ltd. All Rights Reserved.<br>
				서울시 중구 퇴계로 141-7 뉴서울빌딩 10F (주)IBK 시스템
				<span class="middot">&middot;</span> AI공모전 담당자 <span class="middot">&middot;</span>platform@ibksystem.co.kr <span class="middot">&middot;</span> <i class="icon-phone3"></i> 02-3407-6600
			</div>
