...
function fnUpdate(){	 		
	...
	if(!CV_checkPasswordPattern($("input[name='newPassword']").val())){
		return;	
	}
	...
	$.ajax({
		type:"POST",
		url:"${pageContext.request.contextPath}/uss/umt/EgovMberPasswordUpdtAjax.do",
		data: string, 
		dataType:'json',
		timeout:(1000*30),
...
<form:form commandName="mberManageVO" name="mberManageVO" action="${pageContext.request.contextPath}/uss/umt/EgovMberPasswordUpdt.do" method="post" onSubmit="return false;" enctype="multipart/form-data">
...
<div id="wrap">
	...
	<div id="bodywrap">
		<div class="viewWarp">
            ...
            <dl>
                <dt>아이디</dt>
                <dd class="full">${mberManageVO.getMberId() }
                ...
                <dt>직급</dt>
                <dd class="full">${mberManageVO.getTitleNm() }</dd>
                <dt>부서</dt>
                <dd class="full">${mberManageVO.getDeptNmF() }</dd>
            </dl>
