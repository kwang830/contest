...
<div id="wrap">
	...
	<div id="bodywrap">
		<div class="viewWarp">
			<div class="view_title"><img src="/images/bl/bl_circle.gif" class="img_margin1"> 신청서 다운로드</div> 
            <dl>
                <dt>공모전명</dt>
                ...
                <dd class="full">
                    <div class="add_file">
                    	<a href="javascript:fn_egov_downFile('FILE_000000000000331','1')">
							공모전 신청서.hwp&nbsp; [다운로드]
						</a>
                    </div>
                </dd>
                <dt>신청서 예시</dt>
                <dd class="full">
                    <img src="<c:url value='/'/>images/main/download_sample.png" alt="공모전 신청서 샘플이미지" />
                </dd>                
            </dl>
        </div>
	</div>
